(function(root, factory) {
    if(typeof define === 'function' && define.amd) {
        define(['static/js/fieldinfo/moment', 'jquery', 'exports'], function(momentjs, $, exports) {
            root.daterangepicker = factory(root, exports, momentjs, $);
        });
    }else if(typeof exports !== 'undefined'){
        var momentjs = require('static/js/fieldinfo/moment');
...
//      	//console.log('我是第28个方法');
        ...
        {
            alert(t.getDay())
            var valid = !(t.getDay() == 0 || t.getDay() == 6);  // 禁用 星期六 和 星期日
            var _class = '';
