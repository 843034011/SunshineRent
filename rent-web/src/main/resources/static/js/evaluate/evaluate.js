...
$(".block li").find("img").hover(function(e) {
    ...
    for (var i = 0; i < 5; i++) {
        li.find("img").eq(i).attr("src", "../img/evaluate/" + stars[index][i]);//切换每个星星
    }
...
$(".block li").hover(function(e) {
    ...
    $(".evaluate-div ul li:eq(0)").find("img").attr("src","../img/evaluate/x1.png");
    for (var i=0;i<index;i++){

        $(".evaluate-div ul li:eq(0)").find("img").eq(i).attr("src","../img/evaluate/x2.png");
    }
})
...
//印象
$(".evaluate-div-check").click(function(){
